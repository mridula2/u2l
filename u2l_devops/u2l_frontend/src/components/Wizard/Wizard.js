      ...
      <Box width={{ max: 'medium' }}>
        ...
        {showhide === 'C' && (
          <Box>
            ...
            >
              <Box width='medium'>
                <label htmlFor='source_compiler_version'>
            ...
            >
              <Box width='medium'>
                <label htmlFor='target_compiler_version'>
        ...
        {showhide === 'Pro*C' && (
          <Box>
            ...
            >
              <Box width='medium'>
                <label htmlFor='source_pre_compiler'>
                  Source pre-compiler*
                </label>
              </Box>
              <TextInput
            ...
            >
              <Box width='medium'>
                <label htmlFor='source_pre_compiler_version'>
            ...
            >
              <Box width='medium'>
                <label htmlFor='target_pre_compiler_version'>
        ...
        {showhide === 'Shell' && (
          <Box>
            ...
            >
              <Box width='medium'>
                <label htmlFor='source_shell_version'>
            ...
            >
              <Box width='medium'>
                <label htmlFor='target_shell_version'>
