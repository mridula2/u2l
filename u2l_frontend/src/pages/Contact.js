...
const Contact = () => {
  ...
  return (
    ...
    <Box
      ...
      <Box height='600px' width='large' alignSelf='center' direction='row' margin={{ bottom: 'small', left: '15%' }}>

        <Box>
          <Text weight='bold' textAlign='start' pad="medium" margin={{ bottom: 'large' }} size='large'>
            Contact us
          </Text>
        ...
        <Box margin={{ left: '10%' }}>
          ...
          <Box gap="medium" width="medium" margin={{ top: 'medium' }} height=''>
            ...
            >
              ...
              >
                ...
                <Box
                  align={!['xsmall', 'small'].includes(size) ? 'end' : undefined}
