...
// import { FilterRangeSelector } from '../DataTable';  ////////////uncomment this 
            ...
            {filterAttributes &&
              filterAttributes.map(attr => {
                ...
                if (attr.filterType === 'RangeSelector') {
                  return (
                    <h1>FilterRangeSelector</h1>   ///comment this
                    // <FilterRangeSelector key={attr.property} attr={attr} />     /////////uncomment this 
                  );
                }
                return null;
              })}
